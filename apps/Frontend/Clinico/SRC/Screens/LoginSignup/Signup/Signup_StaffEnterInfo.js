...
const Signup_StaffEnterInfo = ({ navigation, route }) => {
  ...
  const handleSignUp = () => {
    if (
      ...
      console.log("fullname :- " + staffDob);
      console.log(password);
      console.log(useremail);
    } else {
      fetch("http://192.168.122.149:3000/ssignup", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...
          staff_name: fullName,
          staff_phone: personalPhoneNumber,
          staff_dob: staffDob,
        ...
        .then((res) => res.json())
        .then((data) => {
          if (data.message === "Staff Registered Successfully") {
        ...
        <View style={styles.formGroup}>
          <View style={styles.radioContainer}>
            <TouchableOpacity
              style={[
                styles.radioButton,
                staffGender === "Male" && styles.selectedRadio,
              ]}
              onPress={() => setStaffGender("Male")}
            >
            ...
            <TouchableOpacity
              style={[
                styles.radioButton,
                staffGender === "Female" && styles.selectedRadio,
              ]}
              onPress={() => setStaffGender("Female")}
            >
...
export default Signup_StaffEnterInfo;
